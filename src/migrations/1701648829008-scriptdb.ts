...
export class Scriptdb1701648829008 implements MigrationInterface {
    name = 'Scriptdb1701648829008'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`condicion_agua\` (\`Id_CondicionAgua\` int NOT NULL AUTO_INCREMENT, \`Descripcion\` varchar(60) NOT NULL, PRIMARY KEY (\`Id_CondicionAgua\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`condicion_cable\` (\`Id_CondicionCable\` int NOT NULL AUTO_INCREMENT, \`Descripcion\` varchar(60) NOT NULL, PRIMARY KEY (\`Id_CondicionCable\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`condicion_internet\` (\`Id_CondicionInternet\` int NOT NULL AUTO_INCREMENT, \`Descripcion\` varchar(60) NOT NULL, PRIMARY KEY (\`Id_CondicionInternet\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`condicion_luz\` (\`Id_CondicionLuz\` int NOT NULL AUTO_INCREMENT, \`Descripcion\` varchar(60) NOT NULL, PRIMARY KEY (\`Id_CondicionLuz\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`detalle_ferias\` (\`Id_DetalleFeria\` int NOT NULL AUTO_INCREMENT, \`Costo\` decimal(8,2) NOT NULL, \`Lugar\` varchar(50) NOT NULL, \`Ubicacion\` varchar(150) NOT NULL, \`idCondicionAgua\` int NULL, \`idCondicionLuz\` int NULL, \`idCondicionInternet\` int NULL, \`idCondicionCable\` int NULL, PRIMARY KEY (\`Id_DetalleFeria\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`roles\` (\`Id_Rol\` int NOT NULL AUTO_INCREMENT, \`descripcion\` varchar(40) NOT NULL, PRIMARY KEY (\`Id_Rol\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`areas\` (\`Id_Area\` int NOT NULL AUTO_INCREMENT, \`descripcion\` varchar(40) NOT NULL, PRIMARY KEY (\`Id_Area\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`ferias\` ADD CONSTRAINT \`FK_582894ad9f1888c9fd5de916d36\` FOREIGN KEY (\`idDetalleFeria\`) REFERENCES \`detalle_ferias\`(\`Id_DetalleFeria\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`ferias\` DROP FOREIGN KEY \`FK_582894ad9f1888c9fd5de916d36\``);
